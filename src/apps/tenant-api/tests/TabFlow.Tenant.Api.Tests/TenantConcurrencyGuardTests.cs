...
public sealed class TenantConcurrencyGuardTests
{
    ...
    {
        var source = File.ReadAllText(FindRepoFile("src/apps/tenant-api/src/TabFlow.Tenant.Api/Tables/TableTokenService.cs"));
    ...
    {
        var endpoints = File.ReadAllText(FindRepoFile("src/apps/tenant-api/src/TabFlow.Tenant.Api/TenantEndpoints.cs"));
        var bills = File.ReadAllText(FindRepoFile("src/apps/tenant-api/src/TabFlow.Tenant.Api/Orders/CustomerBillService.cs"));
