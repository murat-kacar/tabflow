...
public sealed class AuthRateLimitTests
{
    ...
    {
        var program = File.ReadAllText(FindRepoFile("apps/platform-api/src/TabFlow.Platform.Api/Program.cs"));
        var authEndpoints = File.ReadAllText(FindRepoFile("apps/platform-api/src/TabFlow.Platform.Api/Auth/AuthEndpoints.cs"));
