...
public sealed class TenantConcurrencyGuardTests
{
    ...
    {
        var source = File.ReadAllText(FindRepoFile("apps/tenant-api/src/Yenicafe.Tenant.Api/Tables/TableTokenService.cs"));
    ...
    {
        var endpoints = File.ReadAllText(FindRepoFile("apps/tenant-api/src/Yenicafe.Tenant.Api/TenantEndpoints.cs"));
        var bills = File.ReadAllText(FindRepoFile("apps/tenant-api/src/Yenicafe.Tenant.Api/Orders/CustomerBillService.cs"));
